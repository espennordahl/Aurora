...
#  include "embree_vec3b_sse.h"  //!< comment out for not using SSE vectors
#  include "embree_vec3i_sse.h"  //!< comment out for not using SSE vectors
#  include "embree_vec3f_sse.h"  //!< comment out for not using SSE vectors
#endif
